...
class CNN_Feature_extractor():
    ...
    def extract_cnn_features(self, model, video_input_file_path, feature_output_file_path):
    ...
    def scan_and_extract_cnn_features(self, data_dir_path, output_dir_path, model, data_set_name=None):
        ...
        for f in os.listdir(input_data_dir_path):
            ...
            if not os.path.isfile(file_path):
                ...
                for ff in os.listdir(file_path):
                    ...
                    if os.path.isfile(output_feature_file_path):
                        x = np.load(output_feature_file_path)
                    else:
                        x = self.extract_cnn_features(model, video_file_path, output_feature_file_path)
                    y = f
                    y_samples.append(y)
                    x_samples.append(x)
